      ...
      {loggedIn && (location.pathname === '/movies' || location.pathname === '/saved-movies' || location.pathname === '/profile') ? (
        <header className="header header_type_loggedin">
          ...
          <Link to="/" className="logo-link button-hover">
            ...
            <Link className="header__button header__button_type_loggedIn button-active button-hover" to='/saved-movies' >
              Сохраненне фильмы
            </Link>
          </div>
          <Link className="header__button_type_account button-active button-hover" to='/profile'>Аккаунт</Link>
          <a className="header__burger button-hover" onClick={setPopupOpen} ><span className="header__burger-button button-hover"></span></a>
